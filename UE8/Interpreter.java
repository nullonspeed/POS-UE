...
public class Interpreter {
    ...
    private void semanticError(String msg){
        System.err.println("semanticError: "+msg +" in "+ scanner.syLnr +", column "+ scanner.syCnr);
    }
    ...
    public void interpret() {
        IO.println("interpreting started ...");
        MiniJava();
    ...
    public void VarDecl() {
        ...
        while(scanner.sy == Symbol.COMA) {
            ...
            if(!symbolTable.declVar(scanner.identStr))
                semanticError("multiple irgendwos");
            scanner.nextSy();
        }
    ...
    public void Stat() {
        if(scanner.sy == Symbol.IDENT) {
             String desId = scanner.identStr;
             boolean isDecl = symbolTable.isDecl(desId);
            scanner.nextSy();
